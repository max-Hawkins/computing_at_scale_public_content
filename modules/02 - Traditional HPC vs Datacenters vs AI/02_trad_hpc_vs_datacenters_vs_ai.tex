...
\begin{frame}{Scale}
    \begin{itemize}
        \item Exascale computing project (HPC): Limit power to $\approx$20 MW
        \item AI Datacenters: Multi-GW and only limited by energy supply
        \begin{itemize}
            \item Build nuclear plants
            \item Make a datacenter constellation of satellites
        \end{itemize}
    \end{itemize}
\end{frame}
