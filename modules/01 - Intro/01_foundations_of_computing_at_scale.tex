    ...
    \begin{columns}[c, onlytextwidth]
        \column{0.45\textwidth}
            \begin{itemize}
                ...
                \item AI training loads can fluctuate 100s of MWs in milliseconds.
...
\begin{frame}{The Water Cost}
    ...
    \vspace{1em}
    \textbf{Secondary Water Impact:} Thermoelectric power generation is already the largest water consumer in the US.
\end{frame}
...
\begin{frame}{In Space and Under the Sea}
    ...
    \begin{columns}[c, onlytextwidth]
        ...
        \column{0.5\textwidth}
            \textbf{Sea}
            \begin{itemize}
                \item Water/heat sink availability
...
\begin{frame}{Efficiency and Jevons Paradox}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item Efficiency improvements increase overall resource consumption..
...
\begin{frame}{Sufficiency, Sobriety, and Ethics}
    ...
    \begin{itemize}
        \item Example: Do I need a 1 trillion parameter model, or can I use linear regression?
...
\begin{frame}{Summary: Computing at Scale}
    ...
    \begin{enumerate}
        \item \textbf{Foundation:} Information processing is valuable, and we use physical computers to perform this task.
        \item \textbf{Building Blocks:} Transistors drove 50 years of exponential growth (Moore/Dennard), but are hitting lower limits.
        \item \textbf{New Scales:} We now scale up, out, and across to form massive systems.
        \item \textbf{Constraints:} This massive scale is colliding with physical realities: energy grids, water supplies, and communities (us).
    \end{enumerate}
